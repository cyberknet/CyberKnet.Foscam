...
var timerID = -1;
var pVersion = "5.1.0.6";     //plugins version
...
var playerVideo;
var playerAudio;
var livesplClicked = false; // 切换分辨率标志，切换过标为true,H5每切换一次分辨率需要重新打开视频一次
...
function LoadLivePage() {
    ...
    LoadLeftPage(function () {
		...
		if (browserVer.browsers == "Internet Explorer" || browserVer.browsers == "safari") {
	        for (var i = 1; i < 9; i++) {
